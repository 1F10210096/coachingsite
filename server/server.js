        ...
        switch (_a.label) {
          case 0:
            ...
            (userImageUrl = msgData.userImageUrl),
              ...
              (userId_1 = msgData.userId),
              (content = msgData.content);
            console.log('メッセージを受信しました:', msgData);
            return [
              4 /*yield*/,
              prismaClient_1.prismaClient.room.findUnique({
                where: { id: roomId },
              }),
            ];
          case 1:
            ...
            return [
              4 /*yield*/,
              prismaClient_1.prismaClient.comment.create({
                data: {
                  content: content,
                  userId: userId_1,
                  roomId: roomId,
          ...
          case 3:
            ...
            (roomId = msgData.roomId),
              (userId_2 = msgData.userId),
              (userNumber = msgData.userNumber),
              (url = msgData.url),
              (gameTitle = msgData.gameTitle),
          ...
          case 4:
            ...
            if (room) {
              console.log(
                '\u627F\u8AFE\u7528URL\u3092\u53D7\u4FE1\u3057\u307E\u3057\u305F1: '.concat(url)
              );
              clientWebSocket = clientSockets.get(room.hostId);
              console.log(
                '\u627F\u8AFE\u7528URL\u3092\u9001\u4FE1\u3057\u307E\u30592: '.concat(url)
              );
              if (clientWebSocket) {
                console.log(
                  '\u627F\u8AFE\u7528URL\u3092\u9001\u4FE1\u3057\u307E\u3059: '.concat(url)
                );
                // URLを対象のクライアントに送信
                clientWebSocket.send(
                  JSON.stringify({
                ...
                console.log(
                  '\u6307\u5B9A\u3055\u308C\u305F\u30E6\u30FC\u30B6\u30FCID\u306B\u95A2\u9023\u4ED8\u3051\u3089\u308C\u305FWebSocket\u30AF\u30E9\u30A4\u30A2\u30F3\u30C8\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093\u3067\u3057\u305F: '.concat(
                    userId_2
                  )
                );
              }
