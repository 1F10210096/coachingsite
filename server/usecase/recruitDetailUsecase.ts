import type { BosyuuDetail, BosyuuListFrontModel, BosyuuListModel, UserSummaryDetailModel, reviewModel2 } from '$/commonTypesWithClient/models';
import { recruitDetailRepository } from '$/repository/recruitDetailRepository';

import assert from 'assert';

export const recruitDetailUsecase = {
  fetchinfo: async (Id: string): Promise<{bosyuuListFront: BosyuuListFrontModel; teacherProfile: UserSummaryDetailModel;reviewList:reviewModel2[] }> => {
